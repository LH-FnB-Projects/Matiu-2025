...
//ol.proj.get("EPSG:3857").setExtent([19465672.807592, -5050611.815270, 19466198.370492, -5050122.339710]);
var wms_layers = [];
...
lyr_Planting2023_6.set('fieldLabels', {'Site': 'inline label - always visible', 'Date planted': 'hidden field', 'Plants': 'header label - visible with data', 'Notes': 'hidden field', 'Comment': 'hidden field', 'Photo': 'inline label - visible with data', 'Photo-2': 'hidden field', 'Date 2': 'hidden field', 'Photo 2': 'hidden field', 'Notes 2': 'hidden field', 'Point': 'no label', });
lyr_Planting2025_7.set('fieldLabels', {'fid': 'no label', 'Date': 'header label - visible with data', 'Plants': 'header label - visible with data', 'Notes': 'no label', 'Photo': 'inline label - visible with data', 'Photo-2': 'no label', 'Date 2': 'no label', 'Photo 1a': 'no label', 'Plants 2': 'no label', 'Notes 2': 'no label', 'Photo 2a': 'no label', 'Point': 'no label', });
